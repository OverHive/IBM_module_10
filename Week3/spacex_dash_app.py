...
def get_scatter_chart(entered_site, slider):
    if entered_site == 'ALL':
        ...
        scatter_df = scatter_df[slider[1] >= scatter_df["Payload Mass (kg)"] ]
        scatter_df = scatter_df[scatter_df["Payload Mass (kg)"] >= slider[0] ]
        fig = px.scatter(scatter_df, x = "Payload Mass (kg)", y = "class",
        color= "Booster Version Category",
        title='Correlation Between Payload And Succeess for all sites')
        return fig
    else:
        ...
        fig = px.scatter(scatter_df, x ="Payload Mass (kg)", y = "class",
        color= "Booster Version Category",
        title='Correlation Between Payload And Succeess for ' + entered_site )
        return fig
